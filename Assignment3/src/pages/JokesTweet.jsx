      ...
      <div className='bg-black w-[524px] h-[273px] rounded-xl flex items-center justify-center'>
        <div className='w-[90%] h-[92%]'>
          ...
          <div className='mt-4'>
            ...
            <div>
              <p className='font-sans text-[14px] font-normal text-white leading-4'>Even some of the best AI software engineers in the world don’t realize how advanced Tesla AI has become</p>
            </div>
            <div>
          ...
          <div className='w-full h-10 mt-3 border-t border-b border-[#71767B] flex items-center px-3 justify-between'>
            <div className='flex gap-1'>
              ...
              <p className='text-[#71767B] font-sans font-normal text-[10px]'>4.9k</p>
            </div>
            <div className='flex gap-1'>
